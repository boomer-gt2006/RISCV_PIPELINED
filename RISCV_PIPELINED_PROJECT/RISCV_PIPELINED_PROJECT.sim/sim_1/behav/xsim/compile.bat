...
REM
REM Generated by Vivado on Wed Dec 31 14:41:37 +0530 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_dmem_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_dmem_vlog.prj -log xvlog.log
